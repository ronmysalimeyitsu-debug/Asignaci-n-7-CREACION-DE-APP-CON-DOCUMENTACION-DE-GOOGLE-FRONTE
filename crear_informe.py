...
# Crear la carpeta 'reporte' dentro de 'legal_app'
reporte_dir = "reporte"
os.makedirs(reporte_dir, exist_ok=True)

informe_content = """# Informe de Mejoras e Iteraciones - Sistema de Gestión Legal
...
with open(os.path.join(reporte_dir, "informe-mejoras.md"), "w", encoding="utf-8") as f:
    f.write(informe_content)

print("Carpeta 'reporte' y archivo 'informe-mejoras.md' creados exitosamente.")